...
- **Strictly Modular Functions**: No monolithic scripts. Cleanly decoupled into `src/tesla_rag/rag/`, `src/tesla_rag/web.py`, and `tests/`.
...
### 1. Data Ingestion (`src/tesla_rag/rag/data_loader.py`)
...
### 2. Embeddings & Vector Space (`src/tesla_rag/rag/embeddings.py`)
...
### 3. Vector Index & Retrieval (`src/tesla_rag/rag/vector_store.py`)
...
### 4. Answer Generation (`src/tesla_rag/rag/generator.py`)
...
### 5. Web Interface & Server (`src/tesla_rag/web.py`)
