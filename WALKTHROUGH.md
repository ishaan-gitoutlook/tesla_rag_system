...
│
├── src/tesla_rag/rag/data_loader.py                  # Modular PDF ingestion, cleaning & chunking
├── src/tesla_rag/rag/embeddings.py                   # all-MiniLM-L6-v2 model loader & cosine similarity
├── src/tesla_rag/rag/vector_store.py                 # Vector store creation, persistence & top-K retrieval
├── src/tesla_rag/rag/generator.py                    # Prompt builder, local Flan-T5 + Structured Extractor & Gemini API
├── app.py                          # Flask backend server exposing REST endpoints
├── tests/test_rag.py                     # Automated end-to-end test suite
│
├── src/tesla_rag/templates/
│   └── index.html                  # Semantic HTML5 frontend interface
└── src/tesla_rag/static/
...
### `src/tesla_rag/rag/data_loader.py`
...
### `src/tesla_rag/rag/embeddings.py`
...
### `src/tesla_rag/rag/vector_store.py`
...
### `src/tesla_rag/rag/generator.py`
...
All automated verification tests in [`tests/test_rag.py`](file:///C:/Users/Ishaan/workspace/ai_workspace/tesla_rag_system/tests/test_rag.py) passed:
